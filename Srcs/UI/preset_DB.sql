...
CREATE TABLE `monster` (
  ...
  `PresetName` varchar(45) NOT NULL,
  `체력` int DEFAULT NULL,
  `공격력` int DEFAULT NULL,
  `그로기 조건` varchar(45) DEFAULT NULL,
  `공격 속도` int DEFAULT NULL,
  `패링 가능 여부` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `몬스터 종류` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`PlayerID`,`PresetName`),
  KEY `패턴 선택_idx` (`몬스터 종류`),
  CONSTRAINT `패턴 선택` FOREIGN KEY (`몬스터 종류`) REFERENCES `patten` (`패턴 이름`)
...
--
-- Table structure for table `patten`
--

DROP TABLE IF EXISTS `patten`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `patten` (
  `패턴 이름` varchar(45) NOT NULL,
  `패턴 빈도` varchar(45) DEFAULT NULL,
  `패턴 조건` varchar(45) DEFAULT NULL,
  `패턴 사용 유무` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  PRIMARY KEY (`패턴 이름`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `patten`
--

LOCK TABLES `patten` WRITE;
/*!40000 ALTER TABLE `patten` DISABLE KEYS */;
/*!40000 ALTER TABLE `patten` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `player` (
  `PlayerID` varchar(45) NOT NULL,
  `PresetName` varchar(45) NOT NULL,
  `방패 종류` varchar(45) NOT NULL,
  `체력` int NOT NULL,
  `막는 정도` int NOT NULL,
  `키 통합 여부` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `패링 속도` int NOT NULL,
  `회피 판정` int NOT NULL,
  `회피 속도` int NOT NULL,
  `점프 유무` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `무기 종류` varchar(45) NOT NULL,
  `공격력` varchar(45) NOT NULL,
  `공격 속도` varchar(45) NOT NULL,
  `이동 속도` varchar(45) NOT NULL,
  `달리기 속도` varchar(45) NOT NULL,
  PRIMARY KEY (`PlayerID`,`PresetName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-12-04 08:10:33',NULL),('diagnostics.include_raw','OFF','2023-12-04 08:10:33',NULL),('ps_thread_trx_info.max_length','65535','2023-12-04 08:10:33',NULL),('statement_performance_analyzer.limit','100','2023-12-04 08:10:33',NULL),('statement_performance_analyzer.view',NULL,'2023-12-04 08:10:33',NULL),('statement_truncate_len','64','2023-12-04 08:10:33',NULL);
...
-- Dump completed on 2024-02-26 14:56:57
