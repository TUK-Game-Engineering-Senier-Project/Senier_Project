...
private:
	...
	// 아이템 렌더링 빌드
	void BuildRenderItem(char* mat, char* geo, char* arg,
		XMFLOAT3 s, XMFLOAT3 r, XMFLOAT3 t);
...
void SoulSimul::UpdatePlayer()
{
	...
	skullRitem->Mat = mMaterials["playerMat"].get();
	skullRitem->Geo = mGeometries["playerGeo"].get();
