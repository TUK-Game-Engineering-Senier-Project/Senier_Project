...
{
	// ### 바닥 오브젝트 (절대 크기)
	CCubeMeshDiffused* pFloorMesh = new CCubeMeshDiffused(pd3dDevice, pd3dCommandList, 100.0f, 1.0f, 100.0f);

	// ### 적 오브젝트 (배율 크기)
	CEnemyMeshDiffused* pEnemyHeadMesh = new CEnemyMeshDiffused(pd3dDevice, pd3dCommandList, 
		"GolemModel.fbx", "Head", 0.1f, 0.1f, 0.1f);
	CEnemyMeshDiffused* pEnemyBodyMesh = new CEnemyMeshDiffused(pd3dDevice, pd3dCommandList,
		"GolemModel.fbx", "Body", 0.1f, 0.1f, 0.1f);
	CEnemyMeshDiffused* pEnemyJawMesh = new CEnemyMeshDiffused(pd3dDevice, pd3dCommandList,
		"GolemModel.fbx", "Jaw", 0.1f, 0.1f, 0.1f);
	...
	CGameObject* pEnemyHeadObject = new CGameObject();
	CGameObject* pEnemyBodyObject = new CGameObject();
	CGameObject* pEnemyJawObject = new CGameObject();

	// 바닥 
	pFloorObject->SetMesh((CMesh*)pFloorMesh);
	pFloorObject->SetPosition(0.0f, -2.0f, 0.0f);
	m_ppObjects[0] = pFloorObject;

	// 몬스터

	pEnemyHeadObject->SetMesh((CMesh*)pEnemyHeadMesh);
	pEnemyHeadObject->SetPosition(0.0f, 0.0f, 0.0f);
	m_ppObjects[1] = pEnemyHeadObject;

	pEnemyBodyObject->SetMesh((CMesh*)pEnemyBodyMesh);
	pEnemyBodyObject->SetPosition(0.0f, 0.0f, 0.0f);
	m_ppObjects[2] = pEnemyBodyObject;

	pEnemyJawObject->SetMesh((CMesh*)pEnemyJawMesh);
	pEnemyJawObject->SetPosition(0.0f, 0.0f, 0.0f);
	m_ppObjects[3] = pEnemyJawObject;
