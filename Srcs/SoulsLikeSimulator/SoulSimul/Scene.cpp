	...
	* pd3dCommandList)
{
	...
	int nObjects = (2 * xObjects + 1) * (2 * yObjects + 1) * (2 * zObjects + 1);

	CreateCbvSrvDescriptorHeaps(pd3dDevice, nObjects + 1, TEXTURES);
	...
	pObjectShader->BuildObjects(pd3dDevice, pd3dCommandList, this, NULL);
