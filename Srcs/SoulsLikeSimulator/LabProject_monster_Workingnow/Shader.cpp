	...
	* pd3dCommandList)
{
	...
	CEnemyMeshDiffused* pEnemyMesh = new CEnemyMeshDiffused(pd3dDevice, pd3dCommandList, 
		"fbx/GolemModel.fbx", texture_dir, 0.1f, 0.1f, 0.1f);

	m_nObjects = 2;
	m_ppObjects = new CGameObject * [m_nObjects];

	CGameObject* pFloorObject = new CGameObject();
	CGameObject* pEnemyObject = new CGameObject();
	...
	// 몬스터
	pEnemyObject->SetMesh((CMesh*)pEnemyMesh);
